  ...
  const values = [
    {
      ...
      description: "We're deeply committed to improving lives through better nutrition and education."
    },
    {
      icon: <Users className="h-8 w-8 text-primary" />,
      title: "Customer-Centric",
      description: "Your health journey is our priority. We provide personalized guidance and support."
    },
    {
      icon: <Award className="h-8 w-8 text-primary" />,
      title: "Quality Excellence",
      description: "We source only the highest quality ingredients for our supplements and recommendations."
    },
    {
      icon: <Shield className="h-8 w-8 text-primary" />,
      title: "Scientific Integrity",
      description: "Our advice is grounded in scientific research and evidence-based practices."
    }
  ];
  ...
  const teamMembers = [
    {
      ...
      image: "https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=250&q=80"
    },
    {
      name: "Priya Patel",
      role: "Dietetics Specialist",
    ...
    },
    {
      name: "Rahul Mehta",
      role: "Fitness Coach",
      image: "https://images.unsplash.com/photo-1566492031773-4f4e44671857?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=250&q=80"
    },
    {
      name: "Ananya Singh",
      role: "Health Researcher",
      image: "https://images.unsplash.com/photo-1567532939604-b6b5b0db2604?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=250&q=80"
    }
  ];
  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-7xl">
      ...
      <motion.section
        ...
        transition={{ duration: 0.8 }}
      >
        <h1 className="text-4xl md:text-5xl font-bold text-primary mb-4">About Nuturemite</h1>
        <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          We're dedicated to improving lives through proper nutrition, expert guidance, and quality supplements.
        </p>
      </motion.section>
        ...
        <div className="order-2 md:order-1">
          ...
          >
            ...
            <p className="text-gray-600 mb-6">
              Nuturemite aims to support individual health by recommending appropriate foods based on body acceptability, contributing to a healthier society. We provide expert advice and timely delivery of quality food supplements to clients, ensuring their well-being.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            ...
            <p className="text-gray-600">
              ...
              suffering. We provide nutritional benefits about foods, and guide you
              to have the right food, at the right time, in the right way as per
              your body requirements. Our registered dietitians and nutritionists
              design various nutrition programs to raise awareness about nutritious
              foods and their role in preventing chronic diseases.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      >
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-gray-600 mb-8">
            ...
            provide appropriate guidance. Our timely response ensures your health
            is not neglected.
          </p>
          <Button size="lg">
            Book a Consultation
            ...
            <Card key={item} className="shadow-md hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 italic mb-6">
                  "Nuturemite has completely transformed my relationship with food. The personalized nutrition plan has helped me feel more energized and healthier than ever before."
                </p>
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Nutrition Program Client</p>
                  </div>
                </div>
              </CardContent>
            </Card>
      ...
      >
        ...
        <p className="text-lg mb-8 max-w-2xl mx-auto">
          Join thousands of individuals who have improved their lives through our nutrition guidance and supplements.
        </p>
