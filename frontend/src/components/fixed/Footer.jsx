     ...
     <footer className="w-full bg-black text-white pt-8 pb-4">
      <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="mb-8 lg:mb-0">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center">
                ...
                <span className="text-sm">+91 891 999 3233</span>
              </div>
              
              <div className="flex items-center">
                <Mail className="h-5 w-5 mr-2 text-white" />
                <span className="text-sm">nuturemite.info</span>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 py-6 border-t border-gray-800">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="#" className="text-gray-400 hover:text-white text-sm">Help & FAQs</Link></li>
              <li><Link to="#" className="text-gray-400 hover:text-white text-sm">Refund policy</Link></li>
              <li><Link to="#" className="text-gray-400 hover:text-white text-sm">Shipping policy</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/products" className="text-gray-400 hover:text-white text-sm">Product</Link></li>
              <li><Link to="/combos" className="text-gray-400 hover:text-white text-sm">Combos</Link></li>
              <li><Link to="/contact" className="text-gray-400 hover:text-white text-sm">Contact Us</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/our-story" className="text-gray-400 hover:text-white text-sm">Our Story</Link></li>
        ...
        <div className="flex justify-center space-x-6 py-6 border-t border-gray-800">
          <Link to="https://www.facebook.com/Nuturemite/" className="text-gray-400 hover:text-white">
            <Facebook className="h-5 w-5" />
          </Link>
          <Link to="https://www.instagram.com/nuturemite_blog/" className="text-gray-400 hover:text-white">
            <Instagram className="h-5 w-5" />
          </Link>
          <Link to="https://www.youtube.com/channel/UCX1EgOA4GP0PJO893cHtbbA" className="text-gray-400 hover:text-white">
            <Youtube className="h-5 w-5" />
          </Link>
          <Link to="https://x.com/nuturemite" className="text-gray-400 hover:text-white">
            <Twitter className="h-5 w-5" />
          </Link>
          <Link to="https://www.linkedin.com/showcase/nuturemite/about/" className="text-gray-400 hover:text-white">
